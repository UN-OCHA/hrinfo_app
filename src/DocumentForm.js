...
class DocumentForm extends React.Component {
  ...
  render() {
        ...
        return (
		<form onSubmit={this.props.handleSubmit} noValidate="noValidate" className={this.props.status === 'was-validated'
            ...
            {(this.props.status === 'submitting' || this.props.status === 'deleting') && <CircularProgress />}
            {(this.props.match.params.id && this.props.status !== 'deleting') && <Button color="secondary" variant="contained" onClick={this.props.handleDelete}>Delete</Button>}
        </form>);
    }
}
