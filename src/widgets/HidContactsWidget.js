...
class HidContactsWidget extends React.Component {
...
class HidContactsWidgetSettings extends React.Component {
  state = {
    items: [],
    inputNumber: 1
  };
...
export {HidContactsWidgetSettings, HidContactsWidget};
